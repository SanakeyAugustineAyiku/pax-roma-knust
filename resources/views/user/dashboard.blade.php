...
@section('logout')
    ...
    <a class="waves-effect" style="text-decoration: none;" href="{{ route('user.logout') }}" onclick="event.preventDefault();
...
<li><a class="waves-effect" href="{{route('user.home')}}">Dashboard</a></li>
